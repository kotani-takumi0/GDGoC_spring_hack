...
const firebaseConfig = {
  apiKey: process.env.NEXT_PUBLIC_FIREBASE_API_KEY ?? 'AIzaSyA05d00SlwfPuY6ffFHxr48XVbocnMs_LU',
  ...
  messagingSenderId: process.env.NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID ?? '928205117994',
  appId: process.env.NEXT_PUBLIC_FIREBASE_APP_ID ?? '1:928205117994:web:04bbdc31d1558914e18153',
} as const;
