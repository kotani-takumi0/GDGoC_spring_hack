...
- [ ] 4.2 Googleログイン・ログアウトUIをHeaderコンポーネントに追加する
...
- [ ] 6.2 Q&A投稿時にFirestoreにベクトル付きでログを保存する処理を実装する
...
- [ ] 6.3 Firestoreベクトル検索インデックスを作成し、類似Q&A検索機能を実装する
